...
<head>
    ...
    <title>Admin:: Laravel Role Ability</title>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                <div class="flex items-center">
                    <svg class="ml-4 -mt-px w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                         xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                    </svg>

                    <a href="https://www.youtube.com/c/djCodeOfficial" target="_blank" class="ml-1 underline">
                        Dj Code
                    </a>
                    ...
                    <a href="https://tailwindcss.com/docs/installation" target="_blank" class="ml-1 underline">
                        Tail Wind Css
                    </a>
                </div>
            </div>
